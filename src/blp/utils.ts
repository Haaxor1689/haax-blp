...
export const toBlpMipMap = (mipMap: number) =>
  BlpMipMap[mipMap] ?? 'MIPS_GENERATED';

export const fromBlpMipMap = (mipMap: BlpMipMap) => BlpMipMap.indexOf(mipMap);

export type BlpMipMap = (typeof BlpMipMap)[number];
